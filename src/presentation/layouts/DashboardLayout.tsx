  ...
  return (
    <main className="flex flex-row mt-7">
      <nav className="hidden sm:flex flex-col ml-5 w-[370px] min-h-[calc(100vh-3.0rem)] bg-white bg-opacity-10 p-5 rounded-3xl">
        <h1 className="text-indigo-500 font-bold text-lg lg:text-3xl bg-gradient-to-br from-white via-white/50 bg-clip-text">
          ReactGPT<span className="text-indigo-500">.</span>
        </h1>
        <span className="text-xl text-indigo-500">Bienvenido</span>
